...
from app.models import (
    Technology, ProfileInfo, AppSettings, Client, Project
)
...
async def seed_sample_client(db: AsyncSession):
...
async def seed_sample_project(db: AsyncSession, client_id):
...
async def main():
    ...
    async with async_session() as db:
        ...
        client = await seed_sample_client(db)
        await seed_sample_project(db, client.id)
